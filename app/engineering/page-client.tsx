  ...
  zh: {
    ...
    pillars: [
      ...
      },
      {
        ...
        title: "快速故障排除",
        tagline: "Fast Troubleshooting",
        body: "量产线上的设备停机就是生产损失。PRT设备的主要驱动单元和传感器可直接访问，并提供使现场工程师无需专业工具即可识别根本原因的诊断级错误信息。",
        specs: [
          "模块化驱动单元设计",
          "传感器直接访问",
          "诊断级错误信息",
      ...
      },
      {
        ...
        title: "操作员友好型工程",
        tagline: "Operator-Friendly Engineering",
        body: "PRT从生产操作员的视角设计操作流程、HMI布局和换辊程序。无需复杂培训即可安全、一致地操作。",
        specs: [
          "直观HMI：逐步操作指引",
          "换辊：单人操作可完成",
          "安全联锁：全覆盖",
    ...
    componentLabel: "部件标准",
    componentBody:
      "PRT设备中所有关键驱动部件均从全球可供应的标准工业供应商处选取。这将产品停产风险降至最低，并确保整个设备服务周期内的零件可用性。",
    componentBrands: ["THK", "Rexroth", "SMC", "Omron", "Mitsubishi", "Panasonic", "Keyence"],
    contactCta: "工程咨询",
    productsCta: "查看设备",
  },
