...
const translations = {
  ko: {
    pageLabel: "장비 라인업",
    title: "Roll-to-Roll 장비",
    subtitle: "리드프레임 및 반도체 패키징 양산 라인을 위한 Roll-to-Roll 라미네이터 · 노광 시스템",
    laminatorSection: "라미네이터",
    exposureSection: "노광 시스템",
    ...
    laminators: [
      {
        ...
        desc: "리드프레임 양산용 Roll-to-Roll 드라이필름 라미네이션 시스템. 서보 기반 장력 제어와 정밀 온도 제어를 통해 연속 양산 환경에 최적화.",
        specs: [
      ...
      },
      {
        ...
        desc: "독립형 Roll-to-Roll 라미네이터. 좁은 웹 폭과 유연한 공정 환경에 대응하는 컴팩트 라미네이션 시스템.",
        specs: [
    ...
    exposures: [
      {
        ...
        desc: "리드프레임 패턴 형성을 위한 Vertical Roll-to-Roll LED 노광 시스템. 8CCD 비전 자동 정렬과 12초 택트 타임으로 고처리량 양산 환경에 대응.",
        specs: [
      ...
      },
      {
        ...
        desc: "수평형 Roll-to-Roll LED 노광 시스템. Vertical 방식과 동일한 광학·정렬 성능을 수평 레이아웃으로 제공.",
        specs: [
          { label: "Resolution", value: "20μm ±2μm (Cr Mask)" },
          { label: "Alignment Accuracy", value: "±5μm" },
          { label: "UV Source", value: "LED UV" },
    ...
    modules: [
      ...
      { title: "Pre-Heater", desc: "최적 라미네이션을 위한 소재 예열 시스템." },
      { title: "Cleaning Unit", desc: "라미네이션·노광 전 표면 이물질 제거를 위한 웹 클리닝 시스템." },
    ],
    whyLabel: "PRT 장비를 선택하는 이유",
    whyPoints: [
      {
        title: "양산 검증된 설계",
        desc: "PRT 장비는 리드프레임 양산 라인에서 수년간 연속 가동된 이력을 가지고 있습니다. 사양서의 이론값이 아닌, 실제 현장 가동 실적으로 증명합니다.",
      },
      {
        title: "안정성 우선 엔지니어링",
  ...
  zh: {
    pageLabel: "设备阵容",
    title: "卷对卷工艺设备",
    subtitle: "面向引线框架及半导体封装量产线的卷对卷层压机与曝光系统。",
    laminatorSection: "层压机",
    exposureSection: "曝光系统",
    ...
    laminators: [
      {
        model: "PRTLA-350A-PT",
        type: "卷对卷热层压机",
        desc: "面向引线框架量产的卷对卷干膜层压系统。基于伺服张力控制和精密温度管理，针对连续生产进行了优化。",
        specs: [
          { label: "最大卷材宽度", value: "350 mm" },
          { label: "速度", value: "0.1 ~ 5.0 m/min" },
          { label: "温度精度", value: "±3°C" },
          { label: "压力", value: "±0.1 kg/㎠" },
          { label: "层压类型", value: "卷对卷热层压" },
          { label: "电源", value: "Max. 20kW (220V, 60Hz, 3Φ)" },
          { label: "机器尺寸", value: "3850(W) × 2150(D) × 2400(H) mm" },
          { label: "重量", value: "< 2,000 kg" },
        ],
        materials: "C7025 / CDA194 / AL42",
        application: "引线框架 / 半导体封装",
      },
      {
        model: "PRTLA-300A-SA2",
        type: "独立式卷对卷层压机",
        desc: "适用于较窄卷材宽度和灵活工艺环境的紧凑型独立式卷对卷层压机。",
        specs: [
          { label: "卷材宽度范围", value: "150 ~ 330 mm" },
          { label: "速度", value: "0.05 ~ 5.0 m/min" },
          { label: "温度精度", value: "±3°C" },
          { label: "压力", value: "±0.1 kg/㎠" },
          { label: "层压类型", value: "独立式R2R层压机" },
          { label: "电源", value: "Max. 20kW (220V, 60Hz, 3Φ)" },
          { label: "机器尺寸", value: "4100(W) × 1700(D) × 2600(H) mm" },
          { label: "重量", value: "< 2,000 kg" },
        ],
        materials: "C7025 / CDA194 / AL42",
        application: "引线框架 / 半导体封装",
    ...
    exposures: [
      {
        model: "PRTEX-380VAN-LF-LED",
        type: "垂直卷对卷LED曝光系统",
        desc: "用于引线框架图案形成的垂直卷对卷LED曝光系统。8CCD视觉自动对准和12秒节拍时间，适用于高产量生产环境。",
        specs: [
          { label: "分辨率", value: "20μm ±2μm (Cr Mask)" },
          { label: "对准精度", value: "±5μm" },
          { label: "UV光源", value: "LED UV" },
          { label: "UV波长", value: "365nm" },
          { label: "曝光面积", value: "380(W) × 550(L) mm" },
          { label: "卷材宽度", value: "250 ~ 380 mm" },
          { label: "节拍时间", value: "12 sec" },
          { label: "视觉系统", value: "8CCD视觉对准" },
        ],
        materials: "引线框架 (C7025, CDA194, AL42)",
        application: "引线框架RTR曝光工艺",
      },
      {
        model: "PRTEX-380AN-LF-LED",
        type: "水平卷对卷LED曝光系统",
        desc: "水平卷对卷LED曝光系统。以水平布局提供与垂直型相同的光学和对准性能。",
        specs: [
          { label: "分辨率", value: "20μm ±2μm (Cr Mask)" },
          { label: "对准精度", value: "±5μm" },
          { label: "UV光源", value: "LED UV" },
    ...
    modules: [
      { title: "放卷机 / 收卷机", desc: "具有稳定张力控制的高精度卷轴系统，用于材料供应和收取。" },
      { title: "预热器", desc: "用于最佳层压工艺条件的材料预热系统。" },
      { title: "清洁单元", desc: "层压和曝光前表面颗粒去除的卷材清洁系统。" },
    ],
    whyLabel: "为何选择PRT设备？",
    whyPoints: [
      {
        title: "量产验证设计",
        desc: "PRT设备在引线框架量产线上拥有多年连续运行的记录。能力通过运行历史来证明，而非数据表上的数字。",
      },
      {
        title: "稳定性优先工程",
        desc: "PRT的设计目标不是追求峰值性能数字，而是在真实量产条件下——温度变化、材料偏差、长时间连续运行——保持一致的运行。",
      },
      {
        title: "针对您的生产线设计",
        desc: "卷材宽度、传输速度和工艺配置按照您的具体生产线条件设计，而非强行将选配件配合标准产品。",
      },
      {
        title: "易维护设计",
