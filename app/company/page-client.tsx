        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-8 pb-10 lg:px-8 lg:pt-10 lg:pb-14">
          ...
          <div className="mt-8 lg:mt-10">
            ...
            <div className="relative h-[290px] w-full overflow-hidden border border-slate-700/60 bg-black sm:h-[380px] lg:h-auto lg:aspect-[1915/788]">
              ...
              />
              {/* Seat the photo into the dark page: top + bottom edges dissolve into
                  the section's slate-900 tone (rgba(15,23,42)), with a very light
                  flat wash so the bright original no longer reads as a pasted-in
                  photo. Centre (≈40–76%) stays clear so machinery detail is intact. */}
              <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-0"
                style={{
                  background:
                    "linear-gradient(to top, rgba(15,23,42,0.9) 0%, rgba(15,23,42,0.18) 24%, transparent 42%), linear-gradient(to bottom, rgba(15,23,42,0.6) 0%, transparent 26%), linear-gradient(rgba(15,23,42,0.1), rgba(15,23,42,0.1))",
                }}
              />
              {/* faint blue-tinted inset ring ties the frame to the PRT accent */}
              <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-0"
